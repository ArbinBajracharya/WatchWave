        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-12">
                <div class="blog__details__pic">
                    <img src="{{asset('frontend/images/blog/details/blog-details-pic.jpg')}}" alt="">
                </div>
            </div>
            <div class="col-lg-8">
                <div class="blog__details__content">
                    ...
                    <div class="blog__details__item__text">
                        ...
                        <img src="{{asset('frontend/images/blog/details/bd-item-1.jpg')}}" alt="">
                    ...
                    <div class="blog__details__item__text">
                        ...
                        <img src="{{asset('frontend/images/blog/details/bd-item-2.jpg')}}" alt="">
                        <p>In Japan the idea of a first-year speaking to a senior the way Kageyama did to Asahi is a
                            lot more shocking than it would be in the West, but Tobio calling out teammates in
                            genuinely rude fashion in the middle of a match is what got him isolated in the first
                            place.  It’s better for the Crows to sort this out in practice matches than the real
                    ...
                    <div class="blog__details__item__text">
                        <h4>ID:Ianvaded:</h4>
                        <img src="{{asset('frontend/images/blog/details/bd-item-3.jpg')}}" alt="">
                        <p>In Japan the idea of a first-year speaking to a senior the way Kageyama did to Asahi is a
                            lot more shocking than it would be in the West, but Tobio calling out teammates in
                            genuinely rude fashion in the middle of a match is what got him isolated in the first
                            place.  It’s better for the Crows to sort this out in practice matches than the real
                        ...
                        <div class="blog__details__comment">
                            ...
                            <div class="blog__details__comment__item">
                                <div class="blog__details__comment__item__pic">
                                    <img src="{{asset('frontend/images/blog/details/comment-1.png"')}} alt="">
                                </div>
                            ...
                            <div class="blog__details__comment__item blog__details__comment__item--reply">
                                <div class="blog__details__comment__item__pic">
                                    <img src="{{asset('frontend/images/blog/details/comment-2.png"')}} alt="">
                                </div>
                                <div class="blog__details__comment__item__text">
                                    <span>Sep 08, 2020</span>
                            ...
                            <div class="blog__details__comment__item">
                                <div class="blog__details__comment__item__pic">
                                    <img src="{{asset('frontend/images/blog/details/comment-3.png"')}} alt="">
                                </div>
                                <div class="blog__details__comment__item__text">
                                    <span>Sep 08, 2020</span>
