                        ...
                        <div class="anime__details__widget">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <ul>
                                        @php
                                         $director = implode(", ", array_map('ucfirst', json_decode($details->director)));

                                         $cast = implode(", ", array_map('ucfirst', json_decode($details->cast)));
                                        ...
                                        <li><span>Relase Date:</span> {{$details->relase_date}}</li>
